...
namespace Template
{
	public class OpenTKApp : GameWindow
	{
		...
		protected override void OnLoad( EventArgs e )
		{
			...
			app.parent = this;
			app.Init();
			app.raytracer.screen = new Surface( Width, Height );
			Sprite.target = app.raytracer.screen;
			screenID = app.raytracer.screen.GenTexture();
		...
		protected override void OnRenderFrame( FrameEventArgs e )
		{
			...
			GL.TexImage2D( TextureTarget.Texture2D, 0, PixelInternalFormat.Rgba,
						   app.raytracer.screen.width, app.raytracer.screen.height, 0,
						   OpenTK.Graphics.OpenGL.PixelFormat.Bgra,
						   PixelType.UnsignedByte, app.raytracer.screen.pixels
						 );
